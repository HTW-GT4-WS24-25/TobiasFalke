...
// handles logic of power-ups

public class PowerUpManager : MonoBehaviour, ICollidable
{
    ...
    public void Collide(GameObject powerUp, PlayerStats playerStats, PlayerMovement playerMovement)
    {
